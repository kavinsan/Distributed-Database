...
public class Database {
	...
	public String populate(String table, String column, String value){
		try {
			String populate = "";
			stmt = connection.createStatement();
			...
			connection.commit();
			return String.format("%s has been added to the table %s in %s\n", value, column, this.databaseName);
		
		} catch (SQLException e){
			System.out.println("The tables to populate does not exist or unique data already exist");
	
		}
		return "The tables to populate does not exist or unique data already exist\n";
	}
	//Remove a record from a table in a specific column
	public String remove(String table, String column, String value){
		try {
			String populate = "";
			stmt = connection.createStatement();
			//Populate Client Table
			...
			connection.commit();
			return String.format("%s has been removed from the table %s in %s\n", value, column, this.databaseName);
